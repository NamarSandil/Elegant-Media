...
const I18N = {
  ar: {
    ...
    form_submit: 'إرسال الطلب', form_submit_wa: 'إرسال عبر واتساب',
  ...
  en: {
    ...
    form_submit: 'Send request', form_submit_wa: 'Send via WhatsApp',
  ...
  sv: {
    ...
    form_submit: 'Skicka förfrågan', form_submit_wa: 'Skicka via WhatsApp',
